...
public:
    ...
    bool computeTrajectoryAndYaw(const Eigen::Vector4d &start_pos_i, const Eigen::Vector4d &start_vel,
        ...
        opt.addMaximumMagnitudeConstraint(mav_trajectory_generation::derivative_order::SNAP, 10.);
    ...
    void commandTimerCallback(const ros::TimerEvent&){
        ...
        } else if(current_sample_time_ <= trajectory_4D_.getMaxTime() + 1.){//time shift to go at goal
