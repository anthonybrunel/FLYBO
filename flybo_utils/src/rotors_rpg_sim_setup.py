...
class SimulationManager:
    ...
    def __init__(self):
        ...
        self.initial_position[0] = rospy.get_param('~x_init', self.initial_position[0])  # x, y, z [m]
        self.initial_position[1] = rospy.get_param('~y_init', self.initial_position[1])  # x, y, z [m]
        self.initial_position[2] = rospy.get_param('~z_init', self.initial_position[2])  # x, y, z [m]
